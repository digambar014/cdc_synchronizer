...
VL_INLINE_OPT VlCoroutine Vcdc_sync_tb___024root___eval_initial__TOP__1(Vcdc_sync_tb___024root* vlSelf) {
    ...
    while (1U) {
        co_await vlSelf->__VdlySched.delay(5ULL, nullptr, 
                                           ...
                                           8);
        vlSelf->__Vdlyvval__cdc_sync_tb__DOT__clk__v0 
            = (1U & (~ (IData)(vlSelf->cdc_sync_tb__DOT__clk)));
        vlSelf->__Vdlyvset__cdc_sync_tb__DOT__clk__v0 = 1U;
    }
}
...
VL_INLINE_OPT void Vcdc_sync_tb___024root___nba_sequent__TOP__0(Vcdc_sync_tb___024root* vlSelf) {
    ...
    // Body
    if (vlSelf->__Vdlyvset__cdc_sync_tb__DOT__clk__v0) {
        vlSelf->cdc_sync_tb__DOT__clk = vlSelf->__Vdlyvval__cdc_sync_tb__DOT__clk__v0;
        vlSelf->__Vdlyvset__cdc_sync_tb__DOT__clk__v0 = 0U;
    }
}

VL_INLINE_OPT void Vcdc_sync_tb___024root___nba_sequent__TOP__1(Vcdc_sync_tb___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vcdc_sync_tb__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vcdc_sync_tb___024root___nba_sequent__TOP__1\n"); );
    // Body
...
void Vcdc_sync_tb___024root___eval_nba(Vcdc_sync_tb___024root* vlSelf) {
    ...
    if ((1ULL & vlSelf->__VnbaTriggered.word(0U))) {
        Vcdc_sync_tb___024root___nba_sequent__TOP__1(vlSelf);
    }
}
